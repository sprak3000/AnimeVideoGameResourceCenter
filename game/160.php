...
<table border="0" width="100%">
	<tr>		<td valign="top"><img src="<?php print($directoryLevel); ?>images/games/nesLupin.gif" width="177" height="183" alt="Lupin III Pandora no isan" /></td>		<td valign="top">
			<ul>				<li><strong>System:</strong>  Famicom</li>				<li><strong>Company:</strong></li>
					...
					<ul>						<li>Action</li>					</ul>				<li><strong>FAQ:</strong>  <a target="_blank" href="http://web.archive.org/web/20011128205640/http://www.thesoyokaze.net/talesofthewolf/faq/Famicom.txt">lupinthethird.com</a></li>			</ul><p>It seems Clarice just cannot stay out of trouble.  It was bad enough that she kidnapped and was almost forced
